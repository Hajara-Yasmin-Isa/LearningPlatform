...
const socials = [
  {
    name: 'LinkedIn',
    href: 'https://www.linkedin.com/company/111192921/admin/dashboard/',
    icon: (
...
export function Footer() {
  return (
    <footer className="glass border-t border-white/50 mt-16">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="leading-tight">
              <span className="text-sm font-bold text-slate-900">Littafin Fasaha</span>
